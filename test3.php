...
<center>
   <table>
      <br>
      <font color=white size=5><strong> 수업관리 </strong></font><br><br>
      <hr width = 30%>
      <tr>
         <td>
            <form method="post" action="attendsearch.php">
               <br><center><INPUT type="submit" value="수강과목조회"class="myButton"></center>
            </form>
         </td>
      </tr>
      ...
      <tr>
         <td>
            <form method="post" action="scoresearch.php">
               <center><INPUT type="submit" value="성적조회"class="myButton"></center>
            </form>
         </td>
      </tr>
      ...
      <tr>
         <td>
            <form method="post" action="main.html">
               <center><INPUT type="submit" value="뒤로가기" class="myButton"></center>
            </form>
         </td>
      </tr>
   </table>
