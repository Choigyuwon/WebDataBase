...
<center>
    <table>
        <br>
        <font color=white size=5><strong> 수강과목조회 </strong></font><br><br>
        <hr width = 60%>
        <?php
        $id=$_SESSION['stu_no'];
        $table = "attend";
        ...
        <tr>
        <td bgcolor=#191970><font color=white>수강과목</font></td><td bgcolor=white>$info[1]</td><td bgcolor=#191970><font color=white>수강처리일자</font></td><td bgcolor=white>$info[10]</td>
        </tr>      
